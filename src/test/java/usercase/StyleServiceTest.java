...
public class StyleServiceTest extends AbstractTest {
	...
	public void manageStyleDriver() {
		...
		final Object testingData[][] = {
			...
			{
				"administrator", "style", "description", "newName", "newDescription", null
			},
			...
			{
				"administrator", null, null, "newName", "newDescription", ConstraintViolationException.class
			}
